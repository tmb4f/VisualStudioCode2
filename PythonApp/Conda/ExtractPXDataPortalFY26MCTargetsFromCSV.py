...
# 'Outpatient Oncology': ['Outpatient Oncology'], -- dropped 20260625
# 'Urgent Care': ['Urgent Care'], -- dropped 20260625
...
'NICU': ['NICU'],
'ICH-CAHPS': ['ICH-CAHPS']} # added 20260625
...
fnamein = "Tom's Copy-FY26 MC Goals 06242025_06242025 Staging.txt"

fnameout = "FY26 DP MC Targets.txt"
...
service_line_columns = ['Service_Line','Epic_Department_Id','Epic_Department_Name','Domain','Question','FY2026_Unit_Score','Organization','FY2026_Organization_Score','Service','FY2026_Service_Score','Clinical_Area','FY2026_Clinical_Area_Score','FY2026_All_SL_Score','UVa_Health_Ambulatory','FY2026_UVaHealth_Ambulatory_Score']
...
for i,row in dfs.iterrows():
	...
	if row[2] in Service_Line_Dictionary.keys():
		...
		for index, item in enumerate(topbox_li):        
			...
			if index == 5: FY2026_Unit_Score = topbox_li[index]
			if index == 10: Organization = topbox_li[index]
			if index == 11: FY2026_Organization_Score = topbox_li[index]
			if index == 8: Service = topbox_li[index]
			if index == 9: FY2026_Service_Score = topbox_li[index]
			if index == 6: Clinical_Area = topbox_li[index]
			if index == 7: FY2026_Clinical_Area_Score = topbox_li[index]
			if index == 12: FY2026_All_SL_Score = topbox_li[index]
			if index == 13: UVa_Health_Ambulatory = topbox_li[index]
			if index == 14: FY2026_UVaHealth_Ambulatory_Score = topbox_li[index]
	
		# dfo = dfo.append(dict(zip(service_line_columns, (Service_Line,Epic_Department_Id,Epic_Department_Name,Domain,Question,FY2026_Unit_Score,Organization,FY2026_Organization_Score,Service,FY2026_Service_Score,Clinical_Area,FY2026_Clinical_Area_Score,FY2026_All_SL_Score,UVa_Health_Ambulatory,FY2026_UVaHeath_Ambulatory_Score))),ignore_index=True)
		dfo = dfo._append(dict(zip(service_line_columns, (Service_Line,Epic_Department_Id,Epic_Department_Name,Domain,Question,FY2026_Unit_Score,Organization,FY2026_Organization_Score,Service,FY2026_Service_Score,Clinical_Area,FY2026_Clinical_Area_Score,FY2026_All_SL_Score,UVa_Health_Ambulatory,FY2026_UVaHealth_Ambulatory_Score))),ignore_index=True)

dfo = dfo.fillna('')
dfo.rename(index=str, columns={"FY2026_Unit_Score": "2026"}, inplace=True)

dfo_unpivot_1 = pd.melt(dfo.replace('null',np.nan),
                        id_vars=['Service_Line','Epic_Department_Id','Epic_Department_Name','Domain','Question','Organization','FY2026_Organization_Score','Service','FY2026_Service_Score','Clinical_Area','FY2026_Clinical_Area_Score','FY2026_All_SL_Score','UVa_Health_Ambulatory','FY2026_UVaHealth_Ambulatory_Score'],
                        value_vars=dfo.columns.drop(['Service_Line','Epic_Department_Id','Epic_Department_Name','Domain','Question','Organization','FY2026_Organization_Score','Service','FY2026_Service_Score','Clinical_Area','FY2026_Clinical_Area_Score','FY2026_All_SL_Score','UVa_Health_Ambulatory','FY2026_UVaHealth_Ambulatory_Score']).tolist(),
                        value_name='Unit_Score',
                        var_name='FY') \
                            .dropna() \
                                .sort_values(['Service_Line','Epic_Department_Id','Epic_Department_Name','Domain','Question','Organization','FY2026_Organization_Score','Service','FY2026_Service_Score','Clinical_Area','FY2026_Clinical_Area_Score','FY2026_All_SL_Score','UVa_Health_Ambulatory','FY2026_UVaHealth_Ambulatory_Score'])
...
dfo_unpivot_1.rename(index=str, columns={"FY2026_All_SL_Score": "SL_Score"}, inplace=True)

dfo_unpivot_1.rename(index=str, columns={"FY2026_UVaHealth_Ambulatory_Score": "UVaH_Score"}, inplace=True)

dfo_unpivot_1.rename(index=str, columns={"FY2026_Organization_Score": "Organization_Score"}, inplace=True)
dfo_unpivot_1.rename(index=str, columns={"FY2026_Service_Score": "Service_Score"}, inplace=True)
dfo_unpivot_1.rename(index=str, columns={"FY2026_Clinical_Area_Score": "Clinical_Area_Score"}, inplace=True)


dfo_unpivot_1.rename(index=str, columns={"UVaH_Score": "2026"}, inplace=True)
...
with open(dnameout + "\\" + fnameout,'wb') as fo:
